...
{
	struct inv_reg_map_s *reg;
	int result = 0, i = 0, j = 0, packet_size = 0;
	u8 data[BYTES_PER_SENSOR * 2], d;
	bool has_accl;
	int fifo_count = 0, packet_count = 0, ind = 0, s = 0;
...
{
	int inv_accel_orient = 0, result = 0, i = 0, accel_bias_body[3], out[3];
	int tmp[] = {1, 1, 1};
...
{
	int bank = 0, write_size = 0, size = 0, data = 0, result = 0;
	u16 memaddr = 0;
	struct iio_dev *indio_dev;
	struct inv_mpu_iio_s *st;
